...
$code=$_GET['code'];
$ins = $pdo->prepare("select * from direction where id_direction=$code"); 
...
require_once("connexion.php");
$nom = $_POST['nom'];
$ins = $pdo->prepare("update direction set service='$nom' where id_direction=$code"); 
$ins-> execute();
$_SESSION['message'] = 'Enregistrer avec succès.';
$_SESSION['msg_type'] = 'success';

header("location:Afficher_direction.php");
...
<div class="card">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nom" class="form-control" value="<?php echo $tab['service']?>">
        </div>
