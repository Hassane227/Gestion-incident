...
<tr>
    ...
    <td><a href="Supprimer_declaration_Admin.php?code=<?php echo $el['id_agent'] ?>&code2=<?php echo $el['id_incident'] ?>&code3=<?php echo $el['date_declaration'] ?>&code4=<?php echo $el['motif'] ?>" class="btn btn-danger" onclick="return confirm('Voulez-vous vraiment supprimer ')">Supprimer</a></td>
    <td><a href="Modifier_declaration_Admin.php?code=<?php echo $el['id_agent'] ?>&code2=<?php echo $el['date_declaration'] ?>&code3=<?php echo $el['commentaire'] ?>&code4=<?php echo $el['motif'] ?>" class="btn btn-primary" id="Modifier">Modifier</a></td>
