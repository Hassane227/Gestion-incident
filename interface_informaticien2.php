...
<a href="deconnexion.php" id="deconnexion">Déconnexion</a>
    ...
    <nav class="fixed-menu" >
        ...
        <ul>
        <br><br>
            <li><a href="interface_informaticien2.php">Accueil</a></li>
            <li><a href="incident_a_tratite.php">incident a traité</a></li>
            <li><a href="incident_traiter.php">Liste des incident traité</a></li>  
        </ul>
    </nav>
    <div>
